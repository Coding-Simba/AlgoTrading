		...
		namespace NinjaTrader.NinjaScript.Strategies
		{
			...
			public class OvernightCounter : Strategy
			{
            ...
            {
                Name = "OvernightCounter";
                Calculate = Calculate.OnBarClose; DaysToLoad=1500;
	        ...
	        protected override void OnBarUpdate()
	        {
				...
				if (Momentum(14)[1] > -90 && Momentum(14)[0] < -90) {
					//ATR
					if (useATR) {
				...
				if (High[0] < EMA(50)[0] && High[1] > EMA(50)[0]) {
					//ATR
					if (useATR) {
						 // Exit profit target atr
	                    if (profitTarget > 0)
